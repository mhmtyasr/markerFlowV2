...
{
    public abstract class MarkerFlowWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MarkerFlowWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MarkerFlowWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MarkerFlowDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MarkerFlowDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MarkerFlowDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MarkerFlowDbContext, Task<T>> func)
        {
            T result;
