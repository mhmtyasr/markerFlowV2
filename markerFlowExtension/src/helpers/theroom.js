(function (window, document, namespace) {
    ...
    var eventEmitter = function (event) {
      ...
      if (eventController('mouseout', event) === false) return
      ...
      eventController(event.type, targeet, event)
    }
    ...
    var engine = function (type) {
      ...
      if (type === 'start') {
        ...
        document.addEventListener('mouseout', eventEmitter)
        ...
        document.removeEventListener('mouseout', eventEmitter)
